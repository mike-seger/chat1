...
public class HttpLoggingFilter implements Filter {
    ...
    private static final String bufferName = "HttpLoggingFilterBuffer";
    private static final String inputStreamName = "HttpLoggingFilterInputStream";
...
//                    .getTypesafeRequestMap(httpServletRequest);
            ...
            final StringBuilder logMessage = new StringBuilder(
                   ...
                   // .append("]\n[REQUEST PARAMETERS:").append(requestMap)
                    .append("]\n[REQUEST BODY:")
                    .append(new String(bufferedRequest.getBuffer()))
                    .append("]\n[REMOTE ADDRESS:")
    ...
    private static final class BufferedRequestWrapper extends
        ...
        public BufferedRequestWrapper(HttpServletRequest req)
                throws IOException {
            super(req);
            Object attr=req.getAttribute(bufferName);
            if(attr==null) {
    ...
    private static final class BufferedServletInputStream extends
        ...
        public int read(byte[] buf, int off, int len) {
            int res = this.bais.read(buf, off, len);
            System.out.println("Read:================================");
            byte [] newBuf=new byte[res];
            System.arraycopy(buf, off, newBuf, 0, res);
            System.out.println(new String(newBuf));
            System.out.println("\n================================:Read");
            return res;
        }
